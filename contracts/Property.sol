...
// contract Property is checkStamp, AccessControl, IProperty {
...
//     ) checkStamp(_cleaningDuration, _minStayDuration, _maxAnticipationDuration) {
...
//     ) public view checkTime(_startTimestamp, _endTimestamp) returns (bool) {
